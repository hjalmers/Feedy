...
angular.module('myApp.controllers', ['myApp.services'])
  ...
  .controller('MyCtrl1', ['$scope', '$rootScope','API', function($scope, $rootScope, API, $timeout, $window, bite, ingredients, measures, save) {
        $scope.bite ={};
  ...
  .controller('MyCtrl2', ['$scope','$rootScope','API', function($rootScope, $scope, API) {
        /*$scope.bites = [
            {name:"hej"},
            {name:"hej1"},
            {name:"hej2"}
 ...
 */
    ...
    .controller('authenticateCtrl', ['$scope','$rootScope', 'API', function ($rootScope, $scope, API, $window) {
        ...
        $scope.signup = function(){
            ...
            API.signup(transformRequest(form)).success(function (data) {
                //$rootScope.setToken(email); // create a session kind of thing on the client side
                //$rootScope.hide();
                //$window.location.href = ('#/bucket/list');
                API.isAuthenticated = true
                alert("ett " + JSON.stringify(data));
            }).error(function (error) {
                alert("två " +JSON.stringify(error));
            });
        };
        $scope.login = function(){
            var form = {
            ...
            API.login(transformRequest(form)).success(function (data) {
                //$rootScope.setToken(email); // create a session kind of thing on the client side
                //$rootScope.hide();
                //$window.location.href = ('#/bucket/list');
                API.isAuthenticated = true;
